...
<head>
    ...
    <title>Invalid Password - OHIP Web Application</title>
        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    <h3 class="title has-text-grey">Invalid Password</h3>
                    ...
                    <div class="box">
                        ...
                        <form action="<?php echo $__siteurl; ?>logincheck" method="post">
							...
							<div class="notification is-danger"><button class="delete"></button>Invalid Login Information </div>
